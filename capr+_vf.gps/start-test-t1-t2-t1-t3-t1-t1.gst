...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="start-test-t1-t2-t1-t3-t1-t1">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n33">
        ...
        <node id="n46">
            <attr name="layout">
                <string>258 249 68 72</string>
            </attr>
        </node>
        <node id="n74">
            <attr name="layout">
                <string>104 8 49 54</string>
            </attr>
        </node>
