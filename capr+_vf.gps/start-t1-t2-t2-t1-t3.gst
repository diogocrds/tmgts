...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="start-t1-t2-t2-t1-t3">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n33">
        ...
        <node id="n46">
            <attr name="layout">
                <string>374 204 68 54</string>
            </attr>
        </node>
        <node id="n73">
            <attr name="layout">
                <string>243 438 35 54</string>
            </attr>
        </node>
        <node id="n74">
            <attr name="layout">
                <string>135 292 35 54</string>
            </attr>
        </node>
        <node id="n75">
            <attr name="layout">
                <string>368 493 35 36</string>
            </attr>
        </node>
