...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="start-t1-t2-t1-t1-done">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n15">
        ...
        <node id="n65">
            <attr name="layout">
                <string>170 309 86 90</string>
            </attr>
        </node>
        <node id="n66">
            <attr name="layout">
                <string>304 193 68 54</string>
            </attr>
        </node>
        <node id="n67">
            <attr name="layout">
                <string>10 291 68 90</string>
            </attr>
        </node>
