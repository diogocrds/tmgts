...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="start-t1-t1-t3-done">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n22">
        ...
        <node id="n64">
            <attr name="layout">
                <string>228 537 35 36</string>
            </attr>
        </node>
        <node id="n65">
            <attr name="layout">
                <string>290 374 35 54</string>
            </attr>
        </node>
        <node id="n66">
            <attr name="layout">
                <string>10 777 35 54</string>
            </attr>
        </node>
