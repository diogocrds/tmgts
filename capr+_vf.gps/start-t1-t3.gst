...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="start-t1-t3">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n24">
        ...
        <node id="n52">
            <attr name="layout">
                <string>390 407 56 36</string>
            </attr>
        </node>
        <node id="n53">
            <attr name="layout">
                <string>285 339 67 126</string>
            </attr>
        </node>
        <node id="n54">
            <attr name="layout">
                <string>504 403 35 54</string>
            </attr>
        </node>
        <node id="n56">
            <attr name="layout">
                <string>385 259 35 54</string>
            </attr>
        </node>
        <node id="n57">
            <attr name="layout">
                <string>10 695 35 54</string>
            </attr>
        </node>
        <node id="n58">
            <attr name="layout">
                <string>203 584 35 36</string>
            </attr>
        </node>
