...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="start-test-t1-t2-t1-t3-t1-t3">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n28">
        ...
        <node id="n79">
            <attr name="layout">
                <string>1053 363 68 54</string>
            </attr>
        </node>
        <node id="n80">
            <attr name="layout">
                <string>1073 8 79 90</string>
            </attr>
        </node>
        <node id="n81">
            <attr name="layout">
                <string>379 222 68 90</string>
            </attr>
        </node>
        <node id="n82">
            <attr name="layout">
                <string>942 418 24 18</string>
            </attr>
        </node>
        ...
        <edge from="n19" to="n29">
            <attr name="label">
                <string>has</string>
            </attr>
        </edge>
        <edge from="n19" to="n39">
            <attr name="label">
                <string>op</string>
            </attr>
        </edge>
        ...
        <edge from="n45" to="n22">
            <attr name="label">
                <string>has</string>
            </attr>
        </edge>
        <edge from="n45" to="n14">
            <attr name="label">
                <string>has</string>
            </attr>
        </edge>
