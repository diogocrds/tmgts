...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="start-t1-t2-t2-t3-t3-s1">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n20">
            <attr name="layout">
                <string>773 370 79 90</string>
            </attr>
        </node>
        <node id="n7">
            <attr name="layout">
        ...
        <node id="n41">
            <attr name="layout">
                <string>493 553 35 36</string>
            </attr>
        </node>
        <node id="n28">
            <attr name="layout">
                <string>508 172 68 54</string>
            </attr>
        </node>
        <node id="n38">
            <attr name="layout">
        ...
        <node id="n78">
            <attr name="layout">
                <string>260 8 24 18</string>
            </attr>
        </node>
        <node id="n79">
            <attr name="layout">
                <string>238 172 68 54</string>
            </attr>
        </node>
        <node id="n80">
            <attr name="layout">
                <string>10 236 79 90</string>
            </attr>
        </node>
        <node id="n81">
            <attr name="layout">
                <string>423 277 68 90</string>
            </attr>
        </node>
        ...
        <edge from="n43" to="n15">
            <attr name="label">
                <string>has</string>
            </attr>
        </edge>
        <edge from="n43" to="n18">
            <attr name="label">
                <string>op</string>
            </attr>
        </edge>
