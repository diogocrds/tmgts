...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="start-t1-t1-t2-t3-done">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n18">
        ...
        <node id="n37">
            <attr name="layout">
                <string>13 686 68 72</string>
            </attr>
        </node>
        <node id="n36">
            <attr name="layout">
                <string>10 327 79 90</string>
            </attr>
        </node>
        <node id="n4">
            <attr name="layout">
        ...
        <node id="n35">
            <attr name="layout">
                <string>353 319 66 72</string>
            </attr>
        </node>
        <node id="n39">
            <attr name="layout">
                <string>248 172 68 54</string>
            </attr>
        </node>
        <node id="n6">
            <attr name="layout">
        ...
        <node id="n64">
            <attr name="layout">
                <string>10 553 35 36</string>
            </attr>
        </node>
        <node id="n65">
            <attr name="layout">
                <string>767 437 35 54</string>
            </attr>
        </node>
        <node id="n66">
            <attr name="layout">
                <string>537 539 35 36</string>
            </attr>
        </node>
        <node id="n68">
            <attr name="layout">
                <string>10 431 35 54</string>
            </attr>
        </node>
        <node id="n69">
            <attr name="layout">
                <string>657 388 35 54</string>
            </attr>
        </node>
        <node id="n70">
            <attr name="layout">
                <string>265 503 35 36</string>
            </attr>
        </node>
