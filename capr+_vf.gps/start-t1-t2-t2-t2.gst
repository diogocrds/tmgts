...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="start-t1-t2-t2-t2">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n41">
            <attr name="layout">
                <string>770 370 86 90</string>
            </attr>
        </node>
        <node id="n15">
            <attr name="layout">
