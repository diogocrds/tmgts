...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="start-test-t1-t2-t1-t3-t1-t2-t1">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n31">
        ...
        <node id="n49">
            <attr name="layout">
                <string>200 410 68 72</string>
            </attr>
        </node>
        <node id="n18">
            <attr name="layout">
                <string>485 467 35 54</string>
            </attr>
        </node>
        <node id="n33">
            <attr name="layout">
                <string>255 260 68 72</string>
            </attr>
        </node>
        <node id="n28">
            <attr name="layout">
