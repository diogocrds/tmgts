...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="start-t1-t2-t2-t3-t1">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n20">
        ...
        <node id="n74">
            <attr name="layout">
                <string>10 8 24 18</string>
            </attr>
        </node>
        <node id="n75">
            <attr name="layout">
                <string>108 27 68 54</string>
            </attr>
        </node>
        <node id="n76">
            <attr name="layout">
                <string>195 276 79 90</string>
            </attr>
        </node>
        <node id="n77">
            <attr name="layout">
                <string>150 409 68 90</string>
            </attr>
        </node>
        ...
        <edge from="n17" to="n40">
            <attr name="label">
                <string>has</string>
            </attr>
        </edge>
        <edge from="n17" to="n37">
            <attr name="label">
                <string>has</string>
            </attr>
        </edge>
