...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="start2-t1">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n24">
        ...
        <edge from="n1628" to="n1628">
            <attr name="label">
                <string>type:CG</string>
            </attr>
        </edge>
        <edge from="n1628" to="n1630">
            <attr name="label">
                <string>has</string>
            </attr>
        </edge>
        ...
        <edge from="n1628" to="n1629">
            <attr name="label">
                <string>has</string>
            </attr>
        </edge>
        <edge from="n1629" to="n1629">
            <attr name="label">
