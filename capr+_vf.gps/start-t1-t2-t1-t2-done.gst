...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="start-t1-t2-t1-t2-done">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n15">
        ...
        <node id="n63">
            <attr name="layout">
                <string>402 221 24 18</string>
            </attr>
        </node>
        <node id="n64">
            <attr name="layout">
                <string>10 364 68 72</string>
            </attr>
        </node>
        <node id="n65">
            <attr name="layout">
                <string>174 309 79 90</string>
            </attr>
        </node>
        <node id="n66">
            <attr name="layout">
                <string>305 193 68 54</string>
            </attr>
        </node>
        <node id="n67">
            <attr name="layout">
        ...
        <node id="n68">
            <attr name="layout">
                <string>98 376 68 90</string>
            </attr>
        </node>
        <node id="n69">
            <attr name="layout">
                <string>700 370 79 90</string>
            </attr>
        </node>
        <node id="n70">
            <attr name="layout">
                <string>505 172 68 54</string>
            </attr>
        </node>
