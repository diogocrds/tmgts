...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="start-fix">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n5">
        ...
        <node id="n55">
            <attr name="layout">
                <string>305 423 56 36</string>
            </attr>
        </node>
        <node id="n56">
            <attr name="layout">
                <string>287 762 35 36</string>
            </attr>
        </node>
        <node id="n57">
            <attr name="layout">
                <string>230 423 67 126</string>
            </attr>
        </node>
        <node id="n59">
            <attr name="layout">
                <string>194 359 67 126</string>
            </attr>
        </node>
        <node id="n71">
            <attr name="layout">
                <string>10 326 86 90</string>
            </attr>
        </node>
        <node id="n72">
            <attr name="layout">
                <string>260 214 68 54</string>
            </attr>
        </node>
        <node id="n73">
            <attr name="layout">
                <string>391 213 24 18</string>
            </attr>
        </node>
        <node id="n74">
            <attr name="layout">
                <string>624 921 68 72</string>
            </attr>
        </node>
        <node id="n96">
            <attr name="layout">
                <string>291 344 66 72</string>
            </attr>
        </node>
        <node id="n97">
            <attr name="layout">
                <string>879 995 35 36</string>
            </attr>
        </node>
        <node id="n98">
            <attr name="layout">
                <string>489 730 74 54</string>
            </attr>
        </node>
        <node id="n129">
            <attr name="layout">
                <string>722 423 86 90</string>
            </attr>
        </node>
        <node id="n130">
            <attr name="layout">
                <string>847 155 68 54</string>
            </attr>
        </node>
        <node id="n131">
            <attr name="layout">
                <string>935 8 24 18</string>
            </attr>
        </node>
        <node id="n132">
            <attr name="layout">
                <string>1083 1068 68 72</string>
            </attr>
        </node>
        <node id="n182">
            <attr name="layout">
                <string>1281 1140 68 72</string>
            </attr>
        </node>
        <node id="n266">
            <attr name="layout">
                <string>1445 1190 49 36</string>
            </attr>
        </node>
        <node id="n388">
            <attr name="layout">
                <string>877 533 68 90</string>
            </attr>
        </node>
        <edge from="n5" to="n5">
            <attr name="label">
        ...
        <edge from="n71" to="n71">
            <attr name="label">
                <string>let:currValue = int:11</string>
            </attr>
        </edge>
        <edge from="n71" to="n71">
            <attr name="label">
