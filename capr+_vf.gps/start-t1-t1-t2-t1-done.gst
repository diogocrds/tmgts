...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="start-t1-t1-t2-t1-done">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n18">
        ...
        <node id="n66">
            <attr name="layout">
                <string>509 547 35 36</string>
            </attr>
        </node>
        <node id="n68">
            <attr name="layout">
                <string>154 417 68 90</string>
            </attr>
        </node>
